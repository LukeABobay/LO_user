...
def get_box(job, Lon, Lat):
    ...
    if job == 'sequim0':
        ...
        aa = [Lon[0], Lon[-1], Lat[0], Lat[-1]]
        vn_list = 'salt,temp,h,Uwind,Vwind,u,v,w,mask_rho,oxygen,phytoplankton,zooplankton,NO3,zeta'
    elif job == 'bobay_test':
        aa = [-125, -124.95, 48.45, 48.5]
        vn_list = 'h,Uwind,Vwind,u,v,w,mask_rho,temp,salt,oxygen,phytoplankton,zooplankton,NO3,zeta'
